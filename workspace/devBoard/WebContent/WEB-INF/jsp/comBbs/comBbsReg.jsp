...
function fn_insertComBbs() {
	...
	frm.attr("action", "<c:url value='/comBbs/insertComBbs.do'/>");
	frm.submit();
}
-->
</script>
	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="content">
				...
				<form:form commandName="trxComBbsVO" enctype="multipart/form-data" runat="server">
					<div class="modify_user">
						<table>
							...
							<tr>
								...
								<td width="85%" nowrap="nowrap"><c:out value="${comBbsVO.rgstId}" /></td>
							</tr>
							<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<td><a href="#LINK"
									...
									<a href="#LINK"
									onclick="javascript:fn_insertComBbs(); return false;">저장</a>
								</td>
							</tr>
						</table>
					</div>

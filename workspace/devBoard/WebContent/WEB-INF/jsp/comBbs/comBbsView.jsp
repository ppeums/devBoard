				...
				<div class="modify_user" >
	                <table>
                   		<tr> 
						    ...
						    <td width="85%" colspan="5" nowrap="nowrap"><c:out value="${result.nttTitle}"/></td>
					    </tr>
					    <tr> 
					        <th width="15%" height="23" nowrap >등록자</th>
					        <td width="85%" nowrap="nowrap"><c:out value="${result.rgstId}"/></td>
					    </tr>
					    <tr> 
						    <th height="23" >내용</th>
						    <td colspan="5">
							    <div id="bbs_cn"><c:out value="${result.nttContent }" escapeXml="false"/></div>
						    </td>
					    </tr>
					</table>
				</div>
				...
				<table border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
				        ...
				        <td>
				        	...
				        	<a href="#LINK" onclick="javascript:fn_updateComBbsModi(); return false;">수정</a> 
				        	<a href="#LINK" onclick="javascript:fn_insertComBbsReply(); return false;">답글</a> 
				        	<a href="#LINK" onclick="javascript:fn_deleteComBbsList(); return false;">삭제</a> 
				        </td>
					</tr>
				</table>
		        </div>

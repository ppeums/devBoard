				...
				<div class="modify_user" >
	                <table>
                   		<tr> 
						    ...
						    <td width="85%" colspan="5" nowrap="nowrap"><c:out value="${trxSampleVO.name}"/></td>
					    </tr>
					    <tr> 
					        <th width="15%" height="23" nowrap >등록자</th>
					        <td width="85%" nowrap="nowrap"><c:out value="${trxSampleVO.regUser}"/></td>
					    </tr>    
					    <tr> 
				...
				<table border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
				        ...
				        <td>
				        	...
				        	<a href="#LINK" onclick="javascript:fn_updateSampleView(); return false;">수정</a> 
				        	<a href="#LINK" onclick="javascript:fn_deleteSample(); return false;">삭제</a> 
				        </td>
					</tr>
				</table>
		        </div>

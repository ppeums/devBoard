			...
			<div id="content">
				...
				<form:form commandName="trxSampleVO">
						...
						<table>
							<tr>
								...
								<td width="85%" colspan="5" nowrap="nowrap"><c:out
										value="${trxSampleVO.name}" /></td>
							</tr>
							<tr>
								<th width="15%" height="23" nowrap>등록자</th>
								<td width="85%" nowrap="nowrap"><c:out
										value="${trxSampleVO.regUser}" /></td>
							</tr>
							<tr>
								<th scope="row">첨부파일</th>
								<td><c:forEach var="result" items="${fileList}"
										varStatus="status">
										<a
					...
					<div class="replyWrite">
						<label for=""><strong>한줄의견</strong> <input type="text"
							id="commentContent" name="commentContent" style="width: 450px"
							onkeyup="fn_commentByteChk();" />
						</label> &nbsp;<span class="btn_gray_01"><a href="#"
							id="insertComment"
							onclick="fn_insertComment('/sample/ajaxInsertLibFreeNoticeComment.do', '<c:out value='${trxSampleVO.id}'/>');">등록</a>
							<span id="currentBytes">0 BYTES / 1,000 BYTES</span> (한글 500자 /
							영문 1,000자)</span>
					</div>
							...
							<table border="0" cellspacing="0" cellpadding="0" align="center">
								<tr>
									...
									<td><a href="#LINK"
										...
										<a href="#LINK"
										onclick="javascript:fn_deleteSample(); return false;">삭제</a>
									</td>
								</tr>
							</table>
						</div>

...
<head>
  <title>그림 삽입</title>
  	...
  	<!-- File upload 기능을 추가할 경우 다음 URL로 변경 (JSP 처리) -->
	<meta http-equiv="Refresh" content="0; URL=<c:url value='/utl/wed/insertImage.do'/>">
...
<table border="0" width="100%" style="padding: 0px; margin: 0px">
  ...
  <tr>
    ...
    <td><input type="text" name="url" id="f_url" style="width:75%"
      ...
      title="Preview the image in a new window">미리보기</button>
    </td>
  </tr>
  <tr>
